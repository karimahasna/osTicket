...
class AdminNav extends StaffNav{
    ...
    function getTabs(){
        ...
        if(!$this->tabs){
            ...
            $tabs=array();
            $tabs['dashboard']=array('desc'=>__('Dashboard'),'href'=>'scheduleTable.php','title'=>__('Admin Dashboard'));
    ...
    function getSubMenus(){
        ...
        foreach($this->getTabs() as $k=>$tab){
            ...
            switch(strtolower($k)){
                case 'dashboard':
                    $subnav[]=array('desc'=>__('Schedule Table'),'href'=>'scheduleTable.php','iconclass'=>'pages');
